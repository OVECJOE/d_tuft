...
const CATEGORY_MAP: Record<string, string> = {
    STOP: 'control', ADD: 'arithmetic', MUL: 'arithmetic', SUB: 'arithmetic',
    DIV: 'arithmetic', SDIV: 'arithmetic', MOD: 'arithmetic', SMOD: 'arithmetic',
    ADDMOD: 'arithmetic', MULMOD: 'arithmetic', EXP: 'arithmetic', SIGNEXTEND: 'arithmetic',
    LT: 'comparison', GT: 'comparison', SLT: 'comparison', SGT: 'comparison',
    EQ: 'comparison', ISZERO: 'comparison',
    AND: 'bitwise', OR: 'bitwise', XOR: 'bitwise', NOT: 'bitwise',
    BYTE: 'bitwise', SHL: 'bitwise', SHR: 'bitwise', SAR: 'bitwise', CLZ: 'bitwise',
    KECCAK256: 'crypto',
    ADDRESS: 'environment', BALANCE: 'environment', ORIGIN: 'environment',
    CALLER: 'environment', CALLVALUE: 'environment', CALLDATALOAD: 'environment',
    CALLDATASIZE: 'environment', CALLDATACOPY: 'environment', CODESIZE: 'environment',
    CODECOPY: 'environment', GASPRICE: 'environment', EXTCODESIZE: 'environment',
    EXTCODECOPY: 'environment', RETURNDATASIZE: 'environment', RETURNDATACOPY: 'environment',
    EXTCODEHASH: 'environment',
    BLOCKHASH: 'block', COINBASE: 'block', TIMESTAMP: 'block', NUMBER: 'block',
    PREVRANDAO: 'block', GASLIMIT: 'block', CHAINID: 'block', SELFBALANCE: 'block',
    BASEFEE: 'block', BLOBHASH: 'block', BLOBBASEFEE: 'block',
    POP: 'stack', MLOAD: 'memory', MSTORE: 'memory', MSTORE8: 'memory',
    SLOAD: 'storage', SSTORE: 'storage',
    JUMP: 'control', JUMPI: 'control', PC: 'stack', MSIZE: 'memory',
    GAS: 'environment', JUMPDEST: 'control',
    TLOAD: 'storage', TSTORE: 'storage', MCOPY: 'memory',
    PUSH0: 'stack',
    CREATE: 'system', CALL: 'system', CALLCODE: 'system', RETURN: 'control',
    DELEGATECALL: 'system', CREATE2: 'system', STATICCALL: 'system',
    REVERT: 'control', INVALID: 'control', SELFDESTRUCT: 'system',
};
