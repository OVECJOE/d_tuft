...
export class Evm {
    ...
    private computeGasCost(instr: Instruction): bigint {
        ...
        switch (instr.opcode.mnemonic) {
            case 'KECCAK256': {
                ...
                const memGas = BigInt(this.memory.expand(
                    Number(this.stack[this.stack.length - 1] ?? 0n) + size
                ));
            ...
            case 'LOG4': {
                ...
                return base + BigInt(this.memory.expand(
                    Number(this.stack[this.stack.length - 1] ?? 0n) + size
                )) + BigInt(topics) * 375n + BigInt(size) * 8n;
            }
            case 'CALL':
            case 'DELEGATECALL':
            case 'STATICCALL':
            case 'CALLCODE': {
                const retOffset = instr.opcode.mnemonic === 'DELEGATECALL'
                    ? Number(this.stack[this.stack.length - 4] ?? 0n)
                    : Number(this.stack[this.stack.length - 5] ?? 0n);
                const retSize = instr.opcode.mnemonic === 'DELEGATECALL'
    ...
    private dispatch(instr: Instruction): boolean {
        ...
        switch (op) {
            case 0x00: this.halt(null); break;
            case 0x01: this.push(this.pop() + this.pop()); break;
            case 0x02: this.push(this.pop() * this.pop()); break;
            case 0x03: { const b = this.pop(); this.push(this.pop() - b); break; }
            case 0x04: { const b = this.pop(); this.push(b === 0n ? 0n : this.pop() / b); break; }
            case 0x05: { const b = toSigned(this.pop()); this.push(b === 0n ? 0n : toSigned(this.pop()) / b); break; }
            case 0x06: { const b = this.pop(); this.push(b === 0n ? 0n : this.pop() % b); break; }
            case 0x07: { const b = toSigned(this.pop()); this.push(b === 0n ? 0n : toSigned(this.pop()) % b); break; }
            case 0x08: { const c = this.pop(); const a = this.pop(); const b = this.pop(); this.push(c === 0n ? 0n : (a + b) % c); break; }
            case 0x09: { const c = this.pop(); const a = this.pop(); const b = this.pop(); this.push(c === 0n ? 0n : (a * b) % c); break; }
            case 0x0a: this.push(pow256(this.pop(), this.pop())); break;
            case 0x0b: this.push(signExtend(this.pop(), this.pop())); break;

            case 0x10: { const b = this.pop(); this.push(bool(this.pop() < b)); break; }
            case 0x11: { const b = this.pop(); this.push(bool(this.pop() > b)); break; }
            case 0x12: { const b = this.pop(); this.push(bool(toSigned(this.pop()) < toSigned(b))); break; }
            case 0x13: { const b = this.pop(); this.push(bool(toSigned(this.pop()) > toSigned(b))); break; }
            case 0x14: this.push(bool(this.pop() === this.pop())); break;
            case 0x15: this.push(bool(this.pop() === 0n)); break;
            case 0x16: this.push(this.pop() & this.pop()); break;
            case 0x17: this.push(this.pop() | this.pop()); break;
            case 0x18: this.push(this.pop() ^ this.pop()); break;
            case 0x19: this.push(~this.pop() & MASK256); break;
            case 0x1a: this.push(getByte(this.pop(), this.pop())); break;
            case 0x1b: this.push(shl256(this.pop(), this.pop())); break;
            case 0x1c: this.push(this.pop() >> (this.pop() & 0xffn)); break;
            case 0x1d: this.push(sar256(this.pop(), this.pop())); break;
            case 0x1e: this.push(clz256(this.pop())); break;
            ...
            case 0x30: this.push(BigInt('0x' + this.call.address.slice(2).padStart(40, '0'))); break;
            case 0x31: this.push(0n); break;
            case 0x32: this.push(BigInt('0x' + this.tx.origin.slice(2).padStart(40, '0'))); break;
            case 0x33: this.push(BigInt('0x' + this.call.caller.slice(2).padStart(40, '0'))); break;
            case 0x34: this.push(this.call.value); break;
            case 0x35: this.push(this.loadCalldataWord(this.pop())); break;
            case 0x36: this.push(BigInt(this.call.calldata.length)); break;
            case 0x37: this.copyCalldataToMemory(); break;
            case 0x38: this.push(BigInt(this.call.code.length)); break;
            case 0x39: this.copyCodeToMemory(); break;
            case 0x3a: this.push(this.tx.gasPrice); break;
            case 0x3b: this.push(0n); break;
            case 0x3c: break;
            case 0x3d: this.push(BigInt(this.returnData.length)); break;
            case 0x3e: this.copyReturnDataToMemory(); break;
            case 0x3f: this.push(0n); break;

            case 0x40: this.push(0n); break;
            case 0x41: this.push(BigInt('0x' + this.block.coinbase.slice(2).padStart(40, '0'))); break;
            case 0x42: this.push(this.block.timestamp); break;
            case 0x43: this.push(this.block.number); break;
            case 0x44: this.push(this.block.prevrandao); break;
            case 0x45: this.push(this.block.gasLimit); break;
            case 0x46: this.push(this.block.chainId); break;
            case 0x47: this.push(0n); break;
            case 0x48: this.push(this.block.baseFee); break;
            case 0x49: this.push(0n); break;
            case 0x4a: this.push(this.block.blobBaseFee); break;

            case 0x50: this.pop(); break;
            case 0x51: this.push(this.memory.load(Number(this.pop()))); break;
            case 0x52: this.memory.store(Number(this.pop()), this.pop()); break;
            case 0x53: this.memory.storeBytes(Number(this.pop()), new Uint8Array([Number(this.pop() & 0xffn)])); break;
            case 0x54: { const { value } = this.storage.get(this.pop()); this.push(value); break; }
            case 0x55: this.storage.set(this.pop(), this.pop()); break;
            case 0x56: this.pc = Number(this.pop()); return true;
            case 0x57: { const dest = this.pop(); const cond = this.pop(); if (cond !== 0n) { this.pc = Number(dest); return true; } break; }
            case 0x58: this.push(BigInt(this.pc)); break;
            case 0x59: this.push(BigInt(this.memory.activeSize)); break;
            case 0x5a: this.push(this.gasRemaining); break;
            case 0x5b: break;
            case 0x5c: this.push(this.transientStorage.get(this.pop().toString(16)) ?? 0n); break;
            case 0x5d: this.transientStorage.set(this.pop().toString(16), this.pop()); break;
            case 0x5e: this.mcopy(); break;

            case 0x5f: this.push(0n); break;
        }
    ...
    private dispatchSystem(op: number, instr: Instruction): boolean {
        switch (op) {
            ...
            case 0xf1: return this.handleCall(instr, 'call');
            case 0xf2: {
                this.pop(); this.pop(); this.pop(); this.pop(); this.pop(); this.pop(); this.pop();
                this.push(0n);
                this.pc += 1;
                return true;
            }
            case 0xf3: this.opReturn(); return false;
            case 0xf4: return this.handleCall(instr, 'delegatecall');
            case 0xf5: {
                this.pop(); this.pop(); this.pop(); this.pop();
                this.push(0n);
                this.pc += 1;
                return true;
            }
            case 0xfa: return this.handleCall(instr, 'staticcall');
            case 0xfd: this.opRevert(); return false;
            case 0xfe: this.halt('INVALID'); return false;
            case 0xff: this.halt('SELFDESTRUCT'); return false;
            default:
                this.pc += 1;
                return true;
        }
    ...
    private handleCall(instr: Instruction, kind: 'call' | 'delegatecall' | 'staticcall'): boolean {
