...
import {
    tryCatch, startSpinner, updateSpinner, stopSpinner,
    success, error, hint, info, sectionHeader, sectionFooter, kv, box,
} from "../utils";
    ...
    program
        ...
        .action(async (input: string, options: {
            ...
            await tryCatch(async () => {
                ...
                console.log('');
                console.log(Panel.create("Decompilation Summary")
                    ...
                    .separator()
                    .stat("Overall confidence", `${computeOverallConfidence(result.functions).toFixed(0)}%`, T.status.warn)
                    .render()
                );
